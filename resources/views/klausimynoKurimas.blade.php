                    ...
                    <div class="card p-3" id="card p-3">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="inputbox mt-3 mr-2"> <input type="text" id="klausimas1" name="klausimas1" placeholder="..." required></div>
                            </div>
                            <div class="col-md-8">
                                <h6 class="text-uppercase">1 klausimo atsakymas: </h6>
                                <div class="inputbox mt-3 mr-2"> <input type="text" id="atsakymas1" name="atsakymas1" placeholder="..." required></div>
                            </div>
                        </div>
                    </div>
                </div>
