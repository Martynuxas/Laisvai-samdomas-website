...
<body>
    ...
    <div class="card">
    	<div class="top">
    		<p>Nuotraukų talpinimas</p>
    		<button type="button">Talpinti</button>
    	</div>
    	<form action="/upload" method="post" class="">
    		<span class="inner">Nuvilkite nuotraukas čia arba <span class="select">Naršykite kompiuterį</span></span>
