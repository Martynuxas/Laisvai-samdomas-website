    ...
    <body>
        <div class="container mt-5 px-5">
            <div class="mb-4">
                ...
                <div class="col-md-8">
                    <div class="card p-3">
                        <form method="post" action="kurtiUzklausa" enctype="multipart/form-data">      
                        @csrf  
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="inputbox mt-2 mr-2"> <input type="text" id="biudzetas" name="biudzetas" placeholder="000" required></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="inputbox mt-3 mr-2"> <input type="text" id="pavadinimas" name="pavadinimas" placeholder="..." required></div>

                            <h6 class="text-uppercase">Apibūdinkite paslauga kurios ieškote, prašome apibūdinti kuo įmanoma detaliau:</h6>
                            <div class="inputbox mt-3 mr-2"> <textarea id="aprasymas" name="aprasymas" placeholder="Aš ieškau.." style="height:200px" required></textarea></div>
                            
                            <h6 class="text-uppercase">Įkelkite nuotraukas:</h6>   
                                <div class="forma">
